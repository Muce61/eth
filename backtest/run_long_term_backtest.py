...
class LongTermBacktestEngine(RealBacktestEngine):
...
def main():
    print("="*60)
    print("Running Long Term Backtest (Nov 1 2024 - Dec 7 2025)")
    print("Data: /Users/muce/1m_data/new_backtest_data_1year_1m")
    
    # Define Time Range (UTC)
    # Beijing: 2024-11-01 00:00 -> UTC: 2024-10-31 16:00
    # Beijing: 2025-12-07 12:00 -> UTC: 2025-12-07 04:00
    
    start_date = "2024-10-31 16:00:00"
    end_date = "2025-12-07 04:00:00"
    
    print(f"Start Date (UTC): {start_date}")
    print(f"End Date (UTC):   {end_date}")
    print("="*60)
    
    engine = LongTermBacktestEngine(initial_balance=100)
