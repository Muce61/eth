...
class Recent3MonthBacktestEngine(RealBacktestEngine):
...
def main():
    print("="*60)
    print("Running 3-Month Backtest (Sept 1 - Dec 8, 2025)")
    print("Data: /Users/muce/1m_data/new_backtest_data_1year_1m")
    
    # Define Time Range (UTC)
    # Beijing: 2025-09-01 00:00 -> UTC: 2025-08-31 16:00
    ...
    engine = Recent3MonthBacktestEngine(initial_balance=100)
