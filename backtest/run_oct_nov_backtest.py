...
class OctNovBacktestEngine(RealBacktestEngine):
...
def main():
    print("="*60)
    print("Running Oct-Nov Backtest (60 Days)")
    print("Data: /Users/muce/1m_data/new_backtest_data_1year_1m")
    print("Target Period: 2025-10-01 to 2025-11-30")
    print("="*60)
    
    engine = OctNovBacktestEngine(initial_balance=100)
    # Run for 60 days (Oct + Nov)
    engine.run(days=60) 
