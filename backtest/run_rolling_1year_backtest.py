...
class RollingYearBacktestEngine(RealBacktestEngine):
...
def main():
    print("="*60)
    print("Running Rolling Universe Backtest (Nov 1 2024 - Dec 8 2025)")
    ...
    engine = RollingYearBacktestEngine(initial_balance=100)
